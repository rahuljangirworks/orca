...
an `orca vm recipe doctor` failure. Veer is a thin wrapper: you guide, detect, and scaffold;
...
```text
ORCA skills get veer-per-workspace-env
```
...
`ORCA skills get veer-per-workspace-env`. Beyond these commands, ask the user rather than
