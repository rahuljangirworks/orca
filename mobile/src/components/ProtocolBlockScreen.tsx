...
export function ProtocolBlockScreen({ verdict }: Props) {
  ...
  const title = isMobileTooOld ? 'Update Veer Mobile' : 'Update Veer on your computer'
  const body = isMobileTooOld
    ? `This desktop needs a newer Veer Mobile app. Update Veer Mobile from ${mobileUpdateTarget.storeName}, then try this host again.`
    : 'This paired desktop app is too old for your current Veer Mobile app. Update Veer on your computer, then try this host again.'
  const recoveryNote =
