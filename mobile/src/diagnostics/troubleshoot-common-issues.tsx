...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Veer.',
      'Windows: Defender Firewall → Allow app — enable Veer for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Veer must be open on your desktop to accept connections.',
      'Try restarting Veer — the companion server starts on launch.',
