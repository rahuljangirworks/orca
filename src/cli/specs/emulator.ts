...
export const EMULATOR_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['emulator', 'list'],
    summary: 'List available/running emulators (Veer-managed + raw serve-sim)',
    usage: 'veer emulator list [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'devices'],
    summary: 'List all emulator devices/AVDs across iOS and Android',
    usage: 'veer emulator devices [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'attach'],
    summary: 'Attach/start helper for a device and make it active for the worktree',
    usage: 'veer emulator attach [device] [--worktree <selector>] [--focus] [--json]',
  ...
  },
  {
    ...
    usage: 'veer emulator tap <x> <y> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'veer emulator type <text> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: "veer emulator gesture '<json>' [--device <id>] [--worktree <selector>] [--json]",
  ...
  },
  {
    ...
    usage: 'veer emulator button <name> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'veer emulator rotate <orientation> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    path: ['emulator', 'exec'],
    summary:
      'Raw passthrough (e.g. veer emulator exec --command "tap 0.5 0.7" or "ca-debug blended on")',
    usage: 'veer emulator exec --command <cmd> [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'command', 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'kill'],
    summary: 'Stop helper for device',
    usage: 'veer emulator kill [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer emulator shutdown [--device <id>] [--emulator <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'install'],
    summary: 'Install an APK onto the target Android device',
    usage: 'veer emulator install <apkPath> [--reinstall] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'veer emulator launch <package> [--activity <name>] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer emulator permissions <grant|revoke> <package> <permission> [--device <id>] [--json]\n       veer emulator permissions reset [--device <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'device',
      'emulator',
  ...
  },
  {
    ...
    usage: 'veer emulator ax [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'logcat'],
    summary: 'Capture a one-shot logcat dump from the Android device',
    usage: 'veer emulator logcat [--lines <n>] [--device <id>] [--worktree <selector>] [--json]',
