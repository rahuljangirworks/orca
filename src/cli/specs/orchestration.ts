...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'veer orchestration run-create --objective <text> [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration run-use --id <run_id> [--from <handle>] [--takeover-legacy] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration send --subject <text> [--to <run:id|dispatch:id|legacy_handle>] [--run <run_id>] [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--outcome <succeeded|failed>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
    ...
    notes: [
      ...
      'Use --to dispatch:<id> for attempt-specific coordinator guidance; Veer durably relays it to a connected worker server.',
  ...
  },
  {
    ...
    usage:
      'veer orchestration check [--terminal <handle>] [--run <run_id>] [--ack <delivery_id>] [--unread | --peek | --all] [--types <type,...>] [--format] [--wait] [--timeout-ms <n>] [--retry-request <id>] [--json]\n' +
  ...
  },
  {
    ...
    usage:
      'veer orchestration reply --id <msg_id> --body <text> [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'veer orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'task-title',
  ...
  },
  {
    ...
    usage:
      'veer orchestration task-list [--status <status>] [--ready] [--brief] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration task-update --id <task_id> --status <status> [--result <json>] [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  ...ORCHESTRATION_WORKER_COMMAND_SPECS,
  {
    ...
    usage:
      'veer orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--run <run_id>] [--inject] [--dry-run] [--return-preamble] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'task',
      'to',
  ...
  },
  {
    ...
    usage:
      'veer orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration ask (--question <text> | --resume <message_id>) [--to <run:id>] [--run <run_id>] [--options <csv>] [--timeout-ms <n>] [--from <handle>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
  ...
  },
  {
    ...
    usage:
      'veer orchestration coordinator-start --spec <text> [--from <handle>] [--poll-interval-ms <n>] [--max-concurrent <n>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'from',
  ...
  },
  {
    ...
    summary: 'Retired: load the current orchestration skill',
    usage: 'veer orchestration coordinator-stop [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration gate-create --task <task_id> --question <text> [--options <json_array>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration gate-resolve --id <gate_id> --resolution <text> [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration gate-list [--task <task_id>] [--status <status>] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'veer orchestration reset (--all | --tasks | --messages) [--retry-request <id>] [--json]',
