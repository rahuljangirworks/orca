...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'veer wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage: 'veer tab profile list [--json]',
  ...
  },
  {
    ...
    usage:
      'veer tab profile create --label <name> [--scope <isolated|imported>] [--no-ua-spoof] [--json]',
