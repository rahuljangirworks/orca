...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Veer runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'veer serve',
      'veer serve --json',
      'veer serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'veer serve --port 6768 --pairing-address 100.64.1.20',
      'veer serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
