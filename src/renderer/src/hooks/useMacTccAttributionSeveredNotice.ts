      ...
      try {
        ...
        toast.warning(
          translate(
            ...
            'macOS permissions may not reach Veer terminals'
          ),
          {
            id: SEVERED_TCC_NOTICE_ID,
            description: translate(
              'auto.hooks.useMacTccAttributionSeveredNotice.description',
              'Running Veer terminals are hosted by a daemon started by a previous Veer installation. macOS may not apply Veer’s Accessibility, Automation, or protected-file permissions to them. Restart the daemon from Manage Sessions to restore access. This will close all running Veer terminals.'
            ),
            duration: Infinity,
            action: {
              label: translate(
