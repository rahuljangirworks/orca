...
const INSTALL_FAILURE =
  "Could not start the update installer. Orca remains open. (Command failed: pkexec dpkg -i '/home/u/.cache/orca-updater/pending/veer_1.5.0_amd64.deb' pkexec must be setuid root)"
