        ...
        <Button size="sm" disabled={connecting} onClick={onConnect}>
          {connecting
            ...
            : needsReconnect
              ...
              : translate('auto.components.artifacts.ArtifactsPage.signIn', 'Sign in to Veer')}
        </Button>
      ) : (
        <div className="flex flex-col items-center gap-2">
          <p className="max-w-sm text-xs leading-5 text-muted-foreground">
            {translate(
              ...
              'Veer account sign-in is not configured on this machine yet.'
            )}
          </p>
