                ...
                <DialogTitle className="text-xl leading-tight">
                  {openLinksInAppDefault
                    ? translate(
                        ...
                        "Keep terminal links in Veer's browser?"
                      )
                    : translate(
                        'auto.components.link.routing.preference.dialog.title',
                        "Open terminal links in Veer's browser?"
                      )}
                </DialogTitle>
                <DialogDescription className="text-sm leading-relaxed">
                  {openLinksInAppDefault
                    ...
                    : translate(
                        ...
                        "Use Veer's browser for terminal links, or keep your system browser."
                      )}
                </DialogDescription>
              </div>
            </DialogHeader>
              ...
              <div className="space-y-1">
                <p>
                  {translate(
                    ...
                    'Veer can use imported cookies for logged-in sites.'
                  )}
                </p>
                <p>
                  {translate(
