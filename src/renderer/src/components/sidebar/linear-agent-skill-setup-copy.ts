...
export function getLinearAgentSkillSetupMissingLabel(
  ...
  if (!cliAvailable && !skillInstalled) {
    return translate(
      ...
      'Veer CLI and Linear agent skill are missing.'
    )
  }
  if (!cliAvailable) {
    return translate(
...
export function getLinearAgentSkillSetupToastTitle(
  ...
  if (!cliAvailable && !skillInstalled) {
    return translate(
      ...
      'Veer CLI and Linear skill are missing'
    )
  }
  if (!cliAvailable) {
    return translate(
...
function getLinearAgentSkillSetupToastBaseDescription(
  ...
  if (!cliAvailable && !skillInstalled) {
    return translate(
      ...
      'Install the Veer CLI and the Linear skill to enable your agents to read and edit Linear tasks.'
    )
  }
  if (!cliAvailable) {
    return translate(
      'auto.components.sidebar.LinearAgentSkillSetupPrompt.toastInstallCliDescription',
      'Install the Veer CLI to enable your agents to read and edit Linear tasks.'
    )
  }
  return translate(
    'auto.components.sidebar.LinearAgentSkillSetupPrompt.toastInstallSkillDescription',
    'Install the Linear skill to enable your agents to read and edit Linear tasks through the Veer CLI.'
  )
}
