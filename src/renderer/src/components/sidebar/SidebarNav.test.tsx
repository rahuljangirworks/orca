...
describe('SidebarNav', () => {
  ...
  it('updates localized labels when the language changes after mount', async () => {
    ...
    expect(queryButtonByText(container, 'Veer Mobile')).not.toBeNull()
    ...
    expect(queryButtonByText(container, 'Veer 手机端')).not.toBeNull()
  })
  ...
  it('shows the inline hide control only once a device is paired', async () => {
    ...
    expect(queryButtonByText(beforePairing, 'Veer Mobile')).not.toBeNull()
  ...
  it('hides Mobile from its sidebar context menu', async () => {
    ...
    const mobileMenu = getButtonByText(container, 'Veer Mobile').closest(
      '[data-testid="context-menu"]'
    )
