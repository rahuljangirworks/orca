...
export function getActiveServerModeDescription(allowLocalRuntime: boolean): string {
  return allowLocalRuntime
    ...
    : translate(
        ...
        'Selecting a saved server makes this browser use that paired Veer runtime as its default Host.'
      )
}
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Pair another Veer runtime, then connect or disconnect it here.'
              )}
            </p>
          </div>
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Create access links for browsers, mobile clients, or another Veer client to connect back to this running app.'
              )}
            </p>
          </div>
              ...
              <div className="min-w-0 space-y-0.5">
                <div className="text-sm font-medium">
                  {translate(
                    ...
                    'Share this Veer server'
                  )}
                </div>
                <p className="text-xs text-muted-foreground">
                  {translate(
                    'auto.components.settings.RuntimeEnvironmentsPane.84b9b2be05',
                    'Create a revocable access grant so a browser or another Veer client can connect.'
                  )}
                </p>
              </div>
              <Button
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Veer will focus this host and load its projects. Existing terminals and browser tabs on other hosts stay alive.'
              )}
            </DialogDescription>
          </DialogHeader>
          {pendingSwitchValue ? (
            ...
            <DialogDescription>
              {removingActiveServer
                ...
                : translate(
                    ...
                    'This removes the saved server from Veer. It does not change the active server.'
                  )}
            </DialogDescription>
          </DialogHeader>
          {pendingRemove ? (
