  ...
  return {
    ...
    terminalQuickCommands: {
      ...
      description: translate(
        ...
        'Commands are saved on the selected Veer host, then scoped globally or to a project setup. Commands from this device also remain available in remote workspaces.'
      )
    },
    workspaceDirectory: {
