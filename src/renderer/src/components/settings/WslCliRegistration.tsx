...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'veer'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `veer` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Veer itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Veer will register {{value0}} so the command works from WSL terminals.',
