...
import { VEER_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Veer: browse issues, start linked workspaces, and let agents update tickets with /veer-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${VEER_LINEAR_SKILL_NAME}`}
      />
