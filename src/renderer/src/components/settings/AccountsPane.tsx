      ...
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          {translate(
            ...
            'Stored locally. Veer sends it only to platform.minimax.io for usage refreshes.'
          )}
        </p>
      </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Optional. Veer can use your normal Claude login; add accounts only if you want quick switching without moving chat sessions.'
            )}
          </p>
        </div>
              ...
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                {isRemoteAccountScope
                  ...
                  : translate(
                      ...
                      "No managed Claude accounts for {{value0}}. Veer will use that environment's system default Claude login until you add one here.",
                      { value0: accountRuntimeSentenceLabel }
                    )}
              </div>
            ) : (
      ...
      <section key="codex-accounts" id="accounts-codex" className="space-y-4 scroll-mt-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Optional. Veer can use your normal Codex login; add accounts only if you want quick switching in Veer.'
            )}
          </p>
          <p className="text-xs text-muted-foreground">
            {isRemoteAccountScope
              ...
              : translate(
                  ...
                  'Each account keeps its own local sign-in context in Veer. Account auth stays on this device.'
                )}
          </p>
        </div>
        ...
        <SearchableSetting
          ...
          description={translate(
            ...
            'Manage which Codex account Veer uses for live rate limit fetching.'
          )}
              ...
              <span>
                {codexConfigSyncWarning === 'managed-home-unavailable'
                  ? translate(
                      ...
                      'Veer could not read this account\u2019s Codex files just now, so settings may not be syncing. This usually clears on its own \u2014 antivirus or a backup tool briefly locks them.'
                    )
              ...
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                {isRemoteAccountScope
                  ...
                  : translate(
                      ...
                      "No managed Codex accounts for {{value0}}. Veer will use that environment's system default Codex login until you add one here.",
                      { value0: accountRuntimeSentenceLabel }
                    )}
              </div>
            ) : (
      ...
      <section key="gemini" id="accounts-gemini" className="space-y-4 scroll-mt-6">
        ...
        <SearchableSetting
          ...
          description={translate(
            ...
            'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google. This uses credentials issued to the Gemini CLI app, not Veer. May break if Google updates the CLI. Use at your own risk.'
          )}
          keywords={[
            'gemini',
            'cli',
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google for {{value0}}. This uses credentials issued to the Gemini CLI app, not Veer. May break if Google updates the CLI. Use at your own risk.',
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Removing this account permanently deletes its managed Codex home, including all Codex session history and MCP logins stored inside. This cannot be undone. If the account is currently active, Veer falls back to the system default Codex login.'
              )}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Veer will delete the managed Claude auth for this saved account. If it is currently active, Veer falls back to the system default Claude login.'
              )}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
