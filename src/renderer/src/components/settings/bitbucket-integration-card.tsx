    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Configured via environment variables. Unset the ORCA_BITBUCKET_* variables to manage this credential in Veer.'
        )}
      </p>
    )
  }
      ...
      <p className="text-xs text-muted-foreground">
        {props.storedCredential
          ...
          : translate(
              ...
              'Bitbucket credentials are configured but could not authenticate. Check the token and repository permissions, then restart Veer if environment variables changed.'
            )}
      </p>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Saved in Veer on this machine. ORCA_BITBUCKET_* environment variables take precedence when set.'
        )}
      </p>
    )
  }
