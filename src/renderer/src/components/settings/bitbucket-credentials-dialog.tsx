        ...
        <DialogHeader className="gap-3">
          ...
          <DialogDescription>
            {translate(
              ...
              'Use a Bitbucket Cloud credential to browse pull requests and build statuses. Veer verifies it before saving.'
            )}
          </DialogDescription>
        </DialogHeader>
        {locked ? (
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Bitbucket is already configured through ORCA_BITBUCKET_* environment variables, which take precedence. Unset them to save a credential in Veer.'
            )}
          </p>
        ) : (
