...
export const getGeneralWorkspaceSearchEntries = createLocalizedCatalog(() => [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose whether worktrees created outside Veer appear by default.'
    ),
    keywords: [
...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Veer CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Veer CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Veer skill so agents know to use the Veer CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer Veer version.'
    ),
    keywords: [
