        ...
        <ol className="ml-4 list-decimal space-y-1 text-xs text-muted-foreground">
          <li>
            {translate(
              ...
              'Open Settings → Remote Veer Servers → Share this host.'
            )}
          </li>
          <li>
            {translate(
          ...
          <li>
            {translate(
              ...
              'Generate the link, then copy the “Pair another Veer client” link.'
            )}
          </li>
        </ol>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-[minmax(0,180px)_minmax(0,1fr)]">
        <div className="space-y-2">
          <Label htmlFor="runtime-server-name">
            {translate('auto.components.settings.RuntimeHostAccessForm.name', 'Name in Veer')}
          </Label>
          <Input
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'This only changes how the computer appears in Veer.'
            )}
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p id="runtime-server-access-link-help" className="text-xs text-muted-foreground">
            {translate(
              ...
              'Veer shows the destination before connecting. Credentials stay hidden.'
            )}
          </p>
          {inputError ? (
          ...
          <div className="text-sm font-medium text-destructive">
            {failure.kind === 'host-identity-mismatch'
              ? translate(
                  ...
                  'The reached Veer host does not match this access link'
                )
              : failure.kind === 'access-link-invalid'
                ...
                : failure.kind === 'protocol-incompatible'
                  ? translate(
                      ...
                      'Veer versions are not compatible'
                    )
