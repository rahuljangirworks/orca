        ...
        {qrError ? (
          <p className="flex max-w-sm items-start gap-1.5 text-xs text-destructive" role="alert">
            ...
            <span>
              {translate(
                ...
                'This pairing code couldn’t be rendered as a QR code. Copy it into Veer Mobile instead.'
              )}
            </span>
          </p>
        ) : (
          <p className="text-muted-foreground max-w-xs text-center text-xs">
            {translate(
              ...
              'Scan this code with the Veer mobile app. Each code creates a unique device token.'
            )}
          </p>
        )}
        {pairingUrl && (
