...
export const getBrowserUsePaneSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.browser.use.search.50f0860e18', 'Enable Veer CLI'),
  ...
  },
  {
    ...
    description: translate(
      ...
      "Install the Browser Use skill so agents can operate Veer's browser."
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.browser.use.search.ba4eb53b72',
