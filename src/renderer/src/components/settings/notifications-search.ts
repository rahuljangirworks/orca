...
export const getNotificationsPaneSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Master switch for Veer desktop notifications.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Avoid notifying when Veer is focused on the active worktree.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose the built-in, system, or local audio file Veer plays for desktop notifications.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
