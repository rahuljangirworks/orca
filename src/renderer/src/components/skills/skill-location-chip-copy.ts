  ...
  switch (chip) {
    ...
    case 'newer':
      return translate(
        ...
        'This copy is a later version than the one this build of Veer ships.'
      )
    case 'unrecognized':
      return translate(
    ...
    case 'inaccessible':
      return translate(
        ...
        'Veer couldn’t read this copy (a permissions or file error).'
      )
    case 'duplicate':
      return translate(
    ...
    case 'external-link':
      return translate(
        ...
        'A shortcut pointing outside Veer’s skill folders.'
      )
    case 'broken-link':
      return translate(
