    ...
    return (
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        {translate(
          ...
          'Checking installed Veer skills…'
        )}
      </div>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'No installed Veer skills found.'
        )}
      </p>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'All installed Veer skills are up to date.'
        )}
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'Some installed Veer skills were left out of the update.'
        )}
      </div>
    )
  }
