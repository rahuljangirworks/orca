    ...
    try {
      ...
      setError(
        translate(
          ...
          'Veer could not inspect managed installs on this machine.'
        )
      )
    } finally {
      if (generation === loadGeneration.current) {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Veer account to load version history.'
              )
            : operation.message
        )
        return
    ...
    try {
          ...
          setError(
            operation.status === 'reconnect-required'
              ? translate(
                  ...
                  'Reconnect your Veer account before changing versions.'
                )
              : operation.message
          )
          return
      ...
      setError(
        translate(
          ...
          'Veer could not verify the requested version.'
        )
      )
    } finally {
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Veer could not safely remove this skill.'
        )
      )
    } finally {
      setBusy(false)
