...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Veer Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Veer Mobile')
  })

  it('labels the restore action explicitly when Veer Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
