...
describe('skill-sharing release workflow', () => {
  ...
  it('runs the focused contract and transaction suite with real Windows coverage', () => {
    ...
    expect(platformTest.env.ORCA_REAL_WINDOWS_SKILL_TEST).toBe('0')
    expect(platformTest.env.ORCA_REAL_PROCESS_SKILL_TEST).toBe('0')
    expect(linuxTest.env.ORCA_REAL_PROCESS_SKILL_TEST).toBe('0')
