...
export function getRequiredReleaseAssetNames(tag) {
  ...
  return [
    ...
    `veer_${version}_amd64.deb`,
    `veer_${version}_arm64.deb`,
    `veer-${version}.x86_64.rpm`,
    `veer-${version}.aarch64.rpm`,
    'veer-windows-setup.exe',
    'veer-windows-setup.exe.blockmap',
    `Veer-${version}-mac.zip`,
    `Veer-${version}-mac.zip.blockmap`,
    `Veer-${version}-arm64-mac.zip`,
    `Veer-${version}-arm64-mac.zip.blockmap`,
    'veer-macos-x64.dmg',
    'veer-macos-x64.dmg.blockmap',
    'veer-macos-arm64.dmg',
    'veer-macos-arm64.dmg.blockmap'
  ]
}
