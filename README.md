<h1 align="center">
  <a href="https://github.com/rahuljangirworks/orca"><img src="resources/build/icon.png" alt="Veer" width="64" valign="middle" /></a> Veer ⚔️
</h1>

<p align="center">
  <strong>वीर - Your Coding Warrior</strong><br/>
  <em>Personal fork of Orca - AI-powered development assistant</em>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/license-MIT-08C?style=flat" alt="License: MIT" />
  <img src="https://img.shields.io/badge/Based%20on-Orca-blue?style=flat" alt="Based on Orca" />
  <img src="https://img.shields.io/badge/macOS%20%7C%20Windows%20%7C%20Linux-4493F8?style=flat-square" alt="Supported platforms: macOS, Windows, and Linux" />
</p>

<p align="center">
  <strong>Personal AI coding assistant with complete independence.</strong><br/>
  Run Codex, ClaudeCode, OpenCode or Pi side-by-side — fully local-only, no telemetry, your control.
</p>

## 🏔️ About Veer

**Veer** (वीर - meaning "Brave Warrior" in Sanskrit/Rajasthani) is a personal fork of [Orca](https://github.com/stablyai/orca) by Rahul Jangir.

**Key Differences from Upstream Orca:**
- ✅ **Fully local-only operation** - No data sent to Orca servers
- ✅ **No telemetry or analytics** - Complete privacy
- ✅ **Manual updates via git** - No auto-updater dependency
- ✅ **Personal branding** - Custom name and identity
- ✅ **Mobile connection via Tailscale** - Local network or VPN only
- ❌ **No Orca relay** - Direct connections only

**Upstream Attribution:**
This is a personal fork. All credit for the amazing codebase goes to [Stably AI](https://github.com/stablyai) and the Orca team.

<p align="center">
  <img src="docs/assets/readme-hero.jpg" alt="Veer desktop app running agents in parallel worktrees" width="960" />
</p>
